...
<%@include file="/templates/inc/header.jsp" %>
  ...
  <div class="content-wrapper">
	...
	<table class="table table-bordered" id="datatable">
	  ...
	  <tbody>
	  <%
	  if(request.getSession().getAttribute("nienkhoaList") != null){
		  List<NienKhoa> nienKhoaList = (List<NienKhoa>) request.getSession().getAttribute("nienkhoaList");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action ="<%=request.getContextPath()%>/nienkhoa" method="post">
        	<div class="form-group row">
			    <label for="exampleFormControlFile1" class="col-sm-3">Mã Niên Khóa</label>
