  ...
  <div class="content-wrapper">
	...
	<table class="table table-bordered" id="datatable">
	  ...
	  if(request.getSession().getAttribute("monhocList") != null){
		  List<MonHoc> monHocList = (List<MonHoc>) request.getSession().getAttribute("monhocList");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action ="<%=request.getContextPath()%>/monhoc" method="post">
        	<div class="form-group row">
			  ...
			  <div class="form-group row">
			    ...
			    <%
			    	if(request.getSession().getAttribute("tinchiList") != null){
			    		List<TinChi> tinchiList = (List<TinChi>) request.getSession().getAttribute("tinchiList");
			  ...
			  <div class="form-group row">
			    ...
			    <%
			    	if(request.getSession().getAttribute("theloaiList") != null){
			    		List<TheLoai> theloaiList = (List<TheLoai>) request.getSession().getAttribute("theloaiList");
